...
const PAGE_DEFINITIONS = [
  ...
  ["stockup", "备货协同", "多产品备货需求、协同进度和时间线。", ["direct", "admin"], ["stockup_request_view_own", "stockup_request_view_all"]],
  ["stockup-recommendations", "备货建议", "按库存和动销查看补货建议。", ["direct", "admin"], ["stockup_recommendations_view"]],
  ["stockup-execution", "供应链执行", "需求受理、采购和生产进度。", ["direct", "admin"], ["stockup_request_accept", "stockup_execution_update"]],
  ["stockup-logistics", "物流与到仓", "打包发运、物流 ETA 和仓库收货。", ["warehouse", "direct", "admin"], ["stockup_shipment_update", "stockup_receipt_confirm"]],
